...
public class AddEmpFrame extends javax.swing.JFrame {
    ...
    public AddEmpFrame() {
        initComponents();
        jLabel6.setText("Hello "+UserProfile.getUserName());
        super.setLocationRelativeTo(null);
         String str=null;
        try{
            str=EmployeesDao.getNewId();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            ...
            try{
                ...
                boolean a=EmployeesDao.addEmployee(e);
                if(a==true)
                {
                    JOptionPane.showMessageDialog(null, "Employees Record added Successfully","Success!!",JOptionPane.INFORMATION_MESSAGE);
                    txtEmpId.setText("");
                    txtEmpName.setText("");
                    txtSal.setText("");
